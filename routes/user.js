...
router.get('/profile/:id', userController.getOneUser);

// Route PUT pour modifier un user
router.put('/profile/:id', auth, userController.updateOneUserPseudo);

// Route PUT pour modifier un user(avatar)
router.post('/avatar/:id', auth, multer, userController.updateOneUserFile);

// Route DELETE pour supprimer un user
router.delete('/delete/:id', auth, userController.deactivateUser);
